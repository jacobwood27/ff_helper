...
def write_league_md(league,my_ros_dudes,my_ros_ranks,unowned_ros_dudes,unowned_ros_ranks,def_advice,kick_advice,weekly_team,weekly_tiers,potential_stream_names,potential_stream_pos,potential_stream_tiers,starters):
    ...
    mdFile.new_table(columns=2, rows=int(len(list_of_strings)/2), text=list_of_strings, text_align='center')
